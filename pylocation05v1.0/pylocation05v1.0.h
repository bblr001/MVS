...
private:
	...
	double  CalculateEndColumn();
	double  CalculateEndRowLeft(double& estimateColLeft, Hlong hDispWnd);
	double  CalculateEndRowRight(double& estimateColRight, Hlong hDispWnd);
	...
	double CalculateLastFrameRowLeft(double& estimateColLeft, Hlong hDispWnd);
	double CalculateLastFrameRowRight(double& estimateColRight, Hlong hDispWnd);
private:
	double m_endCol;

...
private:
	...
	int ch;
	Hobject  ImageOrig, Region, Blister, Image2, Chambers;
	Hobject  Rectangle, Pattern, ChambersUnion, Image, ConnectedRegions;
	Hobject  SelectedRegions, RegionTrans, ImageAffinTrans, ImageReduced;
	Hobject  ImageR, ImageG, ImageB, ConnectedRegions0, RegionFillUp;
	Hobject  RegionOpening, Pills, WrongPill, MissingPill, Chamber;
	Hobject  Pill;

	HTuple  Phi, Area1, Row, Column;
	HTuple  HomMat2D, I, J, PhiRef, Area2, RowRef, ColumnRef;

	HTuple  Count, Index, Area3, Number, Area, Row1, Column1;
	HTuple  Min, Max, Range, NumberP, NumberWP, NumberMP;

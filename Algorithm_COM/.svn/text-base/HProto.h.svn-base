/***********************************************************
 * File generated by the HALCON-Compiler hcomp version 10.0
...
LIntExport Herror T_tuple_find(const Htuple T1, const Htuple T2, Htuple *Indices);
LIntExport Herror tuple_find(Hlong T1, Hlong T2, Hlong *Indices);
...
LIntExport Herror T_tuple_split(const Htuple T1, const Htuple T2, Htuple *Substrings);
LIntExport Herror tuple_split(const char *T1, const char *T2, char *Substrings);
LIntExport Herror T_tuple_str_last_n(const Htuple T1, const Htuple T2, Htuple *Substring);
LIntExport Herror tuple_str_last_n(const char *T1, Hlong T2, char *Substring);
LIntExport Herror T_tuple_str_first_n(const Htuple T1, const Htuple T2, Htuple *Substring);
LIntExport Herror tuple_str_first_n(const char *T1, Hlong T2, char *Substring);
LIntExport Herror T_tuple_strrchr(const Htuple T1, const Htuple T2, Htuple *Position);
LIntExport Herror tuple_strrchr(const char *T1, const char *T2, Hlong *Position);
LIntExport Herror T_tuple_strchr(const Htuple T1, const Htuple T2, Htuple *Position);
LIntExport Herror tuple_strchr(const char *T1, const char *T2, Hlong *Position);
LIntExport Herror T_tuple_strrstr(const Htuple T1, const Htuple T2, Htuple *Position);
LIntExport Herror tuple_strrstr(const char *T1, const char *T2, Hlong *Position);
LIntExport Herror T_tuple_strstr(const Htuple T1, const Htuple T2, Htuple *Position);
LIntExport Herror tuple_strstr(const char *T1, const char *T2, Hlong *Position);
...
LIntExport Herror tuple_number(double T, double *Number);
...
LIntExport Herror T_get_error_text(const Htuple ErrorNumber, Htuple *ErrorText);
LIntExport Herror get_error_text(Hlong ErrorNumber, char *ErrorText);
...
LIntExport Herror T_binocular_disparity_mg(const Hobject Image1, const Hobject Image2, Hobject *Disparity, Hobject *Score, const Htuple GrayConstancy, const Htuple GradientConstancy, const Htuple Smoothness, const Htuple InitialGuess, const Htuple CalculateScore, const Htuple MGParamName, const Htuple MGParamValue);
LIntExport Herror binocular_disparity_mg(const Hobject Image1, const Hobject Image2, Hobject *Disparity, Hobject *Score, double GrayConstancy, double GradientConstancy, double Smoothness, double InitialGuess, const char *CalculateScore, const char *MGParamName, const char *MGParamValue);
...
LIntExport Herror binocular_disparity(const Hobject Image1, const Hobject Image2, Hobject *Disparity, Hobject *Score, const char *Method, Hlong MaskWidth, Hlong MaskHeight, double TextureThresh, Hlong MinDisparity, Hlong MaxDisparity, Hlong NumLevels, double ScoreThresh, const char *Filter, const char *SubDisparity);
...
LIntExport Herror T_get_sheet_of_light_result_object_model_3d(const Htuple SheetOfLightModelID, Htuple *ObjectModel3DID);
LIntExport Herror get_sheet_of_light_result_object_model_3d(Hlong SheetOfLightModelID, Hlong *ObjectModel3DID);
...
LIntExport Herror T_fit_primitives_object_model_3d(const Htuple ObjectModel3DID, const Htuple ParamName, const Htuple ParamValue, Htuple *ObjectModel3DOutID);
LIntExport Herror fit_primitives_object_model_3d(Hlong ObjectModel3DID, const char *ParamName, const char *ParamValue, Hlong *ObjectModel3DOutID);
LIntExport Herror T_segment_object_model_3d(const Htuple ObjectModel3DID, const Htuple ParamName, const Htuple ParamValue, Htuple *ObjectModel3DOutID);
LIntExport Herror segment_object_model_3d(Hlong ObjectModel3DID, const char *ParamName, const char *ParamValue, Hlong *ObjectModel3DOutID);
...
LIntExport Herror T_get_text_result(const Htuple TextResultID, const Htuple ResultName, Htuple *Value);
LIntExport Herror get_text_result(Hlong TextResultID, const char *ResultName, Hlong *Value);
...
LIntExport Herror T_get_text_model_param(const Htuple TextModel, const Htuple Param, Htuple *Value);
LIntExport Herror get_text_model_param(Hlong TextModel, const char *Param, Hlong *Value);
LIntExport Herror T_set_text_model_param(const Htuple TextModel, const Htuple Param, const Htuple Value);
LIntExport Herror set_text_model_param(Hlong TextModel, const char *Param, Hlong Value);
...
LIntExport Herror T_reconstruct_surface_stereo(const Hobject Images, const Htuple StereoModelID, Htuple *ObjectModel3DID);
LIntExport Herror reconstruct_surface_stereo(const Hobject Images, Hlong StereoModelID, Hlong *ObjectModel3DID);
...
LIntExport Herror create_stereo_model(Hlong CameraSetupModelID, const char *Method, const char *GenParamName, double GenParamValue, Hlong *StereoModelID);
...
LIntExport Herror T_trainf_ocr_class_box(const Htuple OcrHandle, const Htuple FileName, Htuple *AvgConfidence);
LIntExport Herror trainf_ocr_class_box(Hlong OcrHandle, const char *FileName, double *AvgConfidence);
LIntExport Herror T_write_ocr_trainf(const Hobject Character, const Hobject Image, const Htuple Class, const Htuple FileName);
LIntExport Herror write_ocr_trainf(const Hobject Character, const Hobject Image, const char *Class, const char *FileName);
...
LIntExport Herror T_write_ocr_trainf_image(const Hobject Character, const Htuple Class, const Htuple FileName);
LIntExport Herror write_ocr_trainf_image(const Hobject Character, const char *Class, const char *FileName);
LIntExport Herror T_append_ocr_trainf(const Hobject Character, const Hobject Image, const Htuple Class, const Htuple FileName);
LIntExport Herror append_ocr_trainf(const Hobject Character, const Hobject Image, const char *Class, const char *FileName);
LIntExport Herror T_read_ocr_trainf_names(const Htuple TrainFileNames, Htuple *CharacterNames, Htuple *CharacterCount);
LIntExport Herror read_ocr_trainf_names(const char *TrainFileNames, char *CharacterNames, Hlong *CharacterCount);
LIntExport Herror T_read_ocr_trainf_select(Hobject *Characters, const Htuple TrainFileNames, const Htuple SearchNames, Htuple *FoundNames);
LIntExport Herror read_ocr_trainf_select(Hobject *Characters, const char *TrainFileNames, const char *SearchNames, char *FoundNames);
LIntExport Herror T_read_ocr_trainf(Hobject *Characters, const Htuple TrainFileNames, Htuple *CharacterNames);
...
LIntExport Herror T_refine_surface_model_pose(const Htuple SurfaceModelID, const Htuple ObjectModel3DID, const Htuple InitialPose, const Htuple MinScore, const Htuple ReturnResultHandle, const Htuple GenParamName, const Htuple GenParamValue, Htuple *Pose, Htuple *Score, Htuple *SurfaceMatchingResultID);
LIntExport Herror T_find_surface_model(const Htuple SurfaceModelID, const Htuple ObjectModel3DID, const Htuple RelSamplingDistance, const Htuple KeyPointFraction, const Htuple MinScore, const Htuple ReturnResultHandle, const Htuple GenParamName, const Htuple GenParamValue, Htuple *Pose, Htuple *Score, Htuple *SurfaceMatchingResultID);
...
LIntExport Herror T_create_surface_model(const Htuple ObjectModel3DID, const Htuple RelSamplingDistance, const Htuple GenParamName, const Htuple GenParamValue, Htuple *SurfaceModelID);
LIntExport Herror create_surface_model(Hlong ObjectModel3DID, double RelSamplingDistance, const char *GenParamName, const char *GenParamValue, Hlong *SurfaceModelID);
...
LIntExport Herror T_create_shape_model_3d(const Htuple ObjectModel3DID, const Htuple CamParam, const Htuple RefRotX, const Htuple RefRotY, const Htuple RefRotZ, const Htuple OrderOfRotation, const Htuple LongitudeMin, const Htuple LongitudeMax, const Htuple LatitudeMin, const Htuple LatitudeMax, const Htuple CamRollMin, const Htuple CamRollMax, const Htuple DistMin, const Htuple DistMax, const Htuple MinContrast, const Htuple GenParamNames, const Htuple GenParamValues, Htuple *ShapeModel3DID);
LIntExport Herror T_copy_object_model_3d(const Htuple ObjectModel3DID, const Htuple Attributes, Htuple *CopiedObjectModel3DID);
LIntExport Herror copy_object_model_3d(Hlong ObjectModel3DID, const char *Attributes, Hlong *CopiedObjectModel3DID);
LIntExport Herror T_prepare_object_model_3d(const Htuple ObjectModel3DID, const Htuple Purpose, const Htuple OverwriteData, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror prepare_object_model_3d(Hlong ObjectModel3DID, const char *Purpose, const char *OverwriteData, const char *GenParamName, const char *GenParamValue);
LIntExport Herror T_object_model_3d_to_xyz(Hobject *X, Hobject *Y, Hobject *Z, const Htuple ObjectModel3DID, const Htuple Type, const Htuple CamParam, const Htuple Pose);
LIntExport Herror T_xyz_to_object_model_3d(const Hobject X, const Hobject Y, const Hobject Z, Htuple *ObjectModel3DID);
LIntExport Herror xyz_to_object_model_3d(const Hobject X, const Hobject Y, const Hobject Z, Hlong *ObjectModel3DID);
LIntExport Herror T_get_object_model_3d_params(const Htuple ObjectModel3DID, const Htuple ParamName, Htuple *ParamValue);
LIntExport Herror get_object_model_3d_params(Hlong ObjectModel3DID, const char *ParamName, char *ParamValue);
LIntExport Herror T_project_object_model_3d(Hobject *ModelContours, const Htuple ObjectModel3DID, const Htuple CamParam, const Htuple Pose, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror T_affine_trans_object_model_3d(const Htuple ObjectModel3DID, const Htuple HomMat3D, Htuple *ObjectModel3DIDAffineTrans);
LIntExport Herror T_clear_all_object_model_3d(void);
LIntExport Herror clear_all_object_model_3d(void);
LIntExport Herror T_clear_object_model_3d(const Htuple ObjectModel3DID);
LIntExport Herror clear_object_model_3d(Hlong ObjectModel3DID);
LIntExport Herror T_write_object_model_3d(const Htuple ObjectModel3DID, const Htuple FileType, const Htuple FileName, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror write_object_model_3d(Hlong ObjectModel3DID, const char *FileType, const char *FileName, const char *GenParamName, const char *GenParamValue);
LIntExport Herror T_read_object_model_3d(const Htuple FileName, const Htuple Scale, const Htuple GenParamName, const Htuple GenParamValue, Htuple *ObjectModel3DID, Htuple *Status);
LIntExport Herror read_object_model_3d(const char *FileName, const char *Scale, const char *GenParamName, const char *GenParamValue, Hlong *ObjectModel3DID, char *Status);
LIntExport Herror T_read_object_model_3d_dxf(const Htuple FileName, const Htuple Scale, const Htuple GenParamNames, const Htuple GenParamValues, Htuple *ObjectModel3DID, Htuple *DxfStatus);
LIntExport Herror read_object_model_3d_dxf(const char *FileName, const char *Scale, const char *GenParamNames, double GenParamValues, Hlong *ObjectModel3DID, char *DxfStatus);
...
LIntExport Herror T_get_operator_name(const Htuple Pattern, Htuple *ProcNames);
LIntExport Herror T_get_param_types(const Htuple ProcName, Htuple *InpCtrlParType, Htuple *OutpCtrlParType);
LIntExport Herror T_get_param_num(const Htuple ProcName, Htuple *CName, Htuple *InpObjPar, Htuple *OutpObjPar, Htuple *InpCtrlPar, Htuple *OutpCtrlPar, Htuple *Type);
LIntExport Herror get_param_num(const char *ProcName, char *CName, Hlong *InpObjPar, Hlong *OutpObjPar, Hlong *InpCtrlPar, Hlong *OutpCtrlPar, char *Type);
LIntExport Herror T_get_param_names(const Htuple ProcName, Htuple *InpObjPar, Htuple *OutpObjPar, Htuple *InpCtrlPar, Htuple *OutpCtrlPar);
LIntExport Herror T_get_operator_info(const Htuple ProcName, const Htuple Slot, Htuple *Information);
LIntExport Herror get_operator_info(const char *ProcName, const char *Slot, char *Information);
LIntExport Herror T_get_param_info(const Htuple ProcName, const Htuple ParamName, const Htuple Slot, Htuple *Information);
LIntExport Herror get_param_info(const char *ProcName, const char *ParamName, const char *Slot, char *Information);
LIntExport Herror T_search_operator(const Htuple Keyword, Htuple *ProcNames);
LIntExport Herror T_get_keywords(const Htuple ProcName, Htuple *Keywords);
...
LIntExport Herror T_connect_grid_points(const Hobject Image, Hobject *ConnectingLines, const Htuple Row, const Htuple Col, const Htuple Sigma, const Htuple MaxDist);
LIntExport Herror T_gen_grid_rectification_map(const Hobject Image, const Hobject ConnectingLines, Hobject *Map, Hobject *Meshes, const Htuple GridSpacing, const Htuple Rotation, const Htuple Row, const Htuple Col, const Htuple MapType);
LIntExport Herror T_gen_arbitrary_distortion_map(Hobject *Map, const Htuple GridSpacing, const Htuple Row, const Htuple Col, const Htuple GridWidth, const Htuple ImageWidth, const Htuple ImageHeight, const Htuple MapType);
...
LIntExport Herror T_points_harris_binomial(const Hobject Image, const Htuple MaskSizeGrd, const Htuple MaskSizeSmooth, const Htuple Alpha, const Htuple Threshold, const Htuple Subpix, Htuple *Row, Htuple *Column);
...
LIntExport Herror T_real_to_vector_field(const Hobject Row, const Hobject Col, Hobject *VectorField);
LIntExport Herror real_to_vector_field(const Hobject Row, const Hobject Col, Hobject *VectorField);
...
LIntExport Herror T_optical_flow_mg(const Hobject Image1, const Hobject Image2, Hobject *VectorField, const Htuple Algorithm, const Htuple SmoothingSigma, const Htuple IntegrationSigma, const Htuple FlowSmoothness, const Htuple GradientConstancy, const Htuple MGParamName, const Htuple MGParamValue);
LIntExport Herror optical_flow_mg(const Hobject Image1, const Hobject Image2, Hobject *VectorField, const char *Algorithm, double SmoothingSigma, double IntegrationSigma, double FlowSmoothness, double GradientConstancy, const char *MGParamName, const char *MGParamValue);
...
LIntExport Herror T_gen_bundle_adjusted_mosaic(const Hobject Images, Hobject *MosaicImage, const Htuple HomMatrices2D, const Htuple StackingOrder, const Htuple TransformRegion, Htuple *TransMat2D);
LIntExport Herror T_gen_projective_mosaic(const Hobject Images, Hobject *MosaicImage, const Htuple StartImage, const Htuple MappingSource, const Htuple MappingDest, const Htuple HomMatrices2D, const Htuple StackingOrder, const Htuple TransformRegion, Htuple *MosaicMatrices2D);
LIntExport Herror T_projective_trans_image_size(const Hobject Image, Hobject *TransImage, const Htuple HomMat2D, const Htuple Interpolation, const Htuple Width, const Htuple Height, const Htuple TransformRegion);
LIntExport Herror T_projective_trans_image(const Hobject Image, Hobject *TransImage, const Htuple HomMat2D, const Htuple Interpolation, const Htuple AdaptImageSize, const Htuple TransformRegion);
...
LIntExport Herror T_gen_image_surface_second_order(Hobject *ImageSurface, const Htuple Type, const Htuple Alpha, const Htuple Beta, const Htuple Gamma, const Htuple Delta, const Htuple Epsilon, const Htuple Zeta, const Htuple Row, const Htuple Col, const Htuple Width, const Htuple Height);
LIntExport Herror gen_image_surface_second_order(Hobject *ImageSurface, const char *Type, double Alpha, double Beta, double Gamma, double Delta, double Epsilon, double Zeta, double Row, double Col, Hlong Width, Hlong Height);
LIntExport Herror T_gen_image_surface_first_order(Hobject *ImageSurface, const Htuple Type, const Htuple Alpha, const Htuple Beta, const Htuple Gamma, const Htuple Row, const Htuple Col, const Htuple Width, const Htuple Height);
LIntExport Herror gen_image_surface_first_order(Hobject *ImageSurface, const char *Type, double Alpha, double Beta, double Gamma, double Row, double Col, Hlong Width, Hlong Height);
...
LIntExport Herror T_descript_class_box(const Htuple ClassifHandle, const Htuple Dimensions);
LIntExport Herror descript_class_box(Hlong ClassifHandle, Hlong Dimensions);
...
LIntExport Herror T_create_caltab(const Htuple Width, const Htuple CalTabDescrFile, const Htuple CalTabFile);
LIntExport Herror create_caltab(double Width, const char *CalTabDescrFile, const char *CalTabFile);
LIntExport Herror T_gen_caltab(const Htuple XNum, const Htuple YNum, const Htuple MarkDist, const Htuple DiameterRatio, const Htuple CalTabDescrFile, const Htuple CalTabPSFile);
LIntExport Herror gen_caltab(Hlong XNum, Hlong YNum, double MarkDist, double DiameterRatio, const char *CalTabDescrFile, const char *CalTabPSFile);
LIntExport Herror T_caltab_points(const Htuple CalTabDescrFile, Htuple *X, Htuple *Y, Htuple *Z);
...
LIntExport Herror T_sim_caltab(Hobject *SimImage, const Htuple CalTabDescrFile, const Htuple CameraParam, const Htuple CaltabPose, const Htuple GrayBackground, const Htuple GrayCaltab, const Htuple GrayMarks, const Htuple ScaleFac);
LIntExport Herror T_disp_caltab(const Htuple WindowHandle, const Htuple CalTabDescrFile, const Htuple CameraParam, const Htuple CaltabPose, const Htuple ScaleFac);
...
LIntExport Herror T_find_caltab(const Hobject Image, Hobject *Caltab, const Htuple CalTabDescrFile, const Htuple SizeGauss, const Htuple MarkThresh, const Htuple MinDiamMarks);
LIntExport Herror find_caltab(const Hobject Image, Hobject *Caltab, const char *CalTabDescrFile, Hlong SizeGauss, Hlong MarkThresh, Hlong MinDiamMarks);

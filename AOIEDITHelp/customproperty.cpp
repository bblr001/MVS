...
CTwoButtonsProp::CTwoButtonsProp(CString& strName, CString& strValue,CString& helpDescription,CWnd* wnd):CMFCPropertyGridProperty(strName, strValue,helpDescription)

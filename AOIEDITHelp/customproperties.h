...
{
public:
	CTwoButtonsProp(CString& strName, CString& StrValue,CString& helpDescription, CPropertyFormView * wnd);
...
{
public:
	CCreateButtonsProp(CString& strName, CString& StrValue,CString& helpDescription, CPropertyFormView * wnd);
...
{
public:
	CLoadButtonsProp(CString& strName, CString& StrValue,CString& helpDescription, CPropertyFormView * wnd);

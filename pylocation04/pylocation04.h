...
public:
	...
	bool     computeLocationBlock(Hobject& srcObj, Hobject& rect, double param, Hobject& retRect);
	bool     computeLocationBlockHanfeng3(Hobject& srcObj, Hobject& rect, Hobject& retRect, HTuple& mean, HTuple &dev);

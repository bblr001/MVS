...
public:
	...
	DWORD SetBitmaps(int nBitmapDis, COLORREF crTransColorDis, int nBitmapIn, COLORREF crTransColorIn, int nBitmapOut = NULL, COLORREF crTransColorOut = 0);
	DWORD SetBitmaps(HBITMAP hBitmapDis, COLORREF crTransColorDis, HBITMAP hBitmapIn, COLORREF crTransColorIn, HBITMAP hBitmapOut = NULL, COLORREF crTransColorOut = 0);

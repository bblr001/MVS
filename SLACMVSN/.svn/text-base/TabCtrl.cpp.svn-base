...
_ASSERTE(GetTabWithWindowID(::GetDlgCtrlID(hWnd))==NULL);	// window with this ID has inserted.
// 
...
_ASSERTE(GetTabWithWindowID(::GetDlgCtrlID(hWnd),hTab)==NULL);	// window with this ID has inserted.
// 
...
{	int iMinTabWidth = GetTabMinWidth();
int totalTabsIndent = m_vtrtabs.size() * (rcTabHorzMargin.left + rcTabHorzMargin.right);
...
{	CFont *pOldFont = (CFont *)virtwnd.SelectObject( GetFontSelect() );
...
Tools::ShowWindow(HNDLtoPTR(hTab)->hWnd,true);
...
{	if(tab!=NULL) *tab = *i;
if(idx!=NULL) *idx = i-m_vtrtabs.begin();
return true;
}
return false;
}
...
/////////////////////////////////////////////////////////////////////////////
// 
void TabCtrl::OnTimer(UINT nIDEvent)
{	switch(nIDEvent)
...
pImageList->Draw(pDC,pCtrl->GetTabImage(hTab),pt,ILD_TRANSPARENT);
}
/////////////////////////////////////////////////////////////////////////////
// 
